...
class Game:
    def __init__(self):
        ...
        self.picture_buttons = [
            ...
            button.PictureButton(3 * WIDTH // 4 - IMG_WIDTH // 2 - 10, 3 * HEIGHT // 4 - IMG_HEIGHT // 2 - 10, IMG_WIDTH, IMG_HEIGHT, MAP_4, self, set_map_index_callback, 4)
        ]
        ...
        pygame.display.set_caption("samurai and gunman")
